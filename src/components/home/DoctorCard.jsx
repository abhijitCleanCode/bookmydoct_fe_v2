...
export default function DoctorCard({doctor}) {
    ...
    return (
        <div key={doctor.id} className="group relative bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                ...
                <div className="flex-1 p-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-start">
                            <h3 className="text-2xl font-bold text-gray-900 truncate hover:cursor-pointer" title={doctor?.name}>{doctor?.name.length > 20 ? `${doctor?.name.slice(0,18)}...` : doctor?.name }</h3>
