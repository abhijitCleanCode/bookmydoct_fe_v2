    ...
    <header className="py-4">
      <article className="px-4">
        <p className="text-[18px] leading-[24px] font-medium">
          Book via call: 9957052223 | 8822452046
        </p>
      </article>
                ...
                <Popover>
                  ...
                  >
                    ...
                    {user?.role == "user" && (
                      <>
                        <hr className="m-2 border-slate-300/40" />
                        <MobileNavLink href="/myAppointments">
                          {" "}
                          <Calendar1 /> My Appointments
                        </MobileNavLink>
                        <hr className="m-2 border-slate-300/40" />
                        <MobileNavLink href="/bookedLabTest">
                          {" "}
                          <TestTube2 /> My lab test bookings
                        </MobileNavLink>
                      </>
                    )}
                    <hr className="m-2 border-slate-300/40" />
                    <PopoverButton
                      ...
                      className={
                        "flex w-full p-2 items-center gap-3 text-red-600"
                      }
                    >
                      <LogOut /> Log Out
                    </PopoverButton>
