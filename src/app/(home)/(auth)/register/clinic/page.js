                ...
                <div className="flex flex-1 w-[60%] flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-10 xl:px-10">
                    <div className="w-full mx-auto max-w-lg">
                        <div>
                            ...
                            <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Register clinic</h2>
                            <p className="mt-2 text-sm/6 text-gray-500">
                                Already have a clinic account ?{' '}
                                <Link href={`/login/clinic`} className="font-semibold text-primary hover:underline">
                                    Login
                                </Link>
                            </p>
                        </div>
                        ...
                        <div className="mt-10">
                            <div>
                                <form action="#" method="POST" onSubmit={handleSubmit} className="space-y-6 grid grid-cols-1 md:grid-cols-2 gap-4">
