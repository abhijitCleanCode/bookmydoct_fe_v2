            ...
            <div className="container mx-auto p-6 sm:p-12 max-w-4xl">
                ...
                <div className="space-y-5 mt-5">
                    ...
                    <div className="hover:bg-blue-50 p-6 rounded-xl transition-colors duration-300">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            In rare cases where there may be a billing error or technical issue, we may review the situation. However, refunds are not guaranteed and are assessed on a case-by-case basis at the sole discretion of SUDAMASOLUTIONS TECHNOLOGIES & HEALTH CARE PVT LTD.
                        </p>
                    </div>
