...
const useAdminStore = create(persist(
    (set, get) => ({
        ...
        getSpecializations: async () => {
            try {
                const res = await axiosApi.get('/clinic/doctors/specializations');
        ...
        addSpecialization: async (specializationData) => {
            try {
                const res = await axiosApi.put('/admin/add/specialization', specializationData);
        ...
        deleteSpecialization: async (specializationData) => {
            try {
                await axiosApi.put(`/admin/delete/specialization`, specializationData);
